...
public class ToggleController : MonoBehaviour 
{
	...
	[Serializable]
	public class ToggleChangeEvent : UnityEvent { }
	[SerializeField]
	private ToggleChangeEvent m_OnToggle = new ToggleChangeEvent();

	private bool switching = false;

	public ToggleChangeEvent onToggle
	{
		get { return m_OnToggle; }
		set { m_OnToggle = value; }
	}
